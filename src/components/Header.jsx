   ...
   <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
        ...
        <div className="hidden md:flex w-full h-full items-center justify-between ">
            <Link to={"/"} className="flex items-center gap-2">
                ...
                <p className="text-headingColor text-xl font-bold">FoodXpress</p>
            </Link>
            ...
            <div className="relative flex items-center justify-center" onClick={showCart}> 
             ...
             {cartItems && cartItems.length > 0 && (
              <div className=" absolute -top-3 -right-1.5 w-4 h-4 rounded-full bg-cartNumBg flex items-center justify-center">
            ...
            <div className="relative">
              ...
              {isMenu && (
                ...
                {user && user.email === "aditisaxena2904@gmail.com" && (
                   <Link to={"/createItem"}>
        ...
        <div className="flex items-center justify-between md:hidden w-full h-full">
            ...
            <div className="relative flex items-center justify-center top-1" onClick={showCart}> 
              <MdShoppingCart className="text-textColor text-2xl cursor-pointer"/>
              {cartItems && cartItems.length > 0 && (
              <div className=" absolute -top-3 -right-1.5 w-4 h-4 rounded-full bg-cartNumBg flex items-center justify-center">
              <p className="text-xs text-white font-semibold ">{cartItems.length}</p>
          ...
          <ul className="flex flex-col">
              ...
              >Service</li>
                ...
                <p className="m-2 p-2 shadow-md flex items-center
